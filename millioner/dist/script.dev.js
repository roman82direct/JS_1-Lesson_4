...
rightClick(question1.q, question1.a1, question1.a2, question1.a3, question1.a4); // Первый вопрос
// обработка подсказок
...
a1.onclick = function () {
  ...
  !countHelp ? p2.onclick = function () {
    return fillHelp(a2, a1, a3, a4);
  } : fillPrompt(p2);
  !countCall ? p3.onclick = function () {
    return fillCall(a2);
  } : fillPrompt(p3);
  ...
  a2.onclick = function () {
    ...
    a1.onclick = function () {
      return wrongClick(a1);
    };

    a2.onclick = function () {
      return wrongClick(a2);
    };
